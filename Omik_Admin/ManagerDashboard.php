...
<body>
    ...
    <div class="dashboard-container">
        <nav class="sidebar">
            <ul>
                <li onclick="openPage('schedule')">📅 View Employee Schedule</li>
                <li onclick="openPage('reports')">📊 View Reports</li>
                <li onclick="openPage('sales')">💰 View Sales</li>
                <li onclick="openPage('revenue')">📈 View Revenue</li>
                <li onclick="openPage('feedback')">💬 View Customer Feedback</li>
                <li onclick="openPage('leave')">📝 Manage Leave Requests</li>
                <li onclick="openPage('attendance')">👥 View Staff Attendance</li>
                <li onclick="openPage('summary')">📄 Generate Summary Report</li>
                <li onclick="openPage('payments')">💵 Approve Supplier Payments</li>
            </ul>
        </nav>
    ...
    <footer>
        <p>&copy; 2025 Omik Family Restaurant Management System</p>
    </footer>
    ...
    <script>
        ...
        function openPage(action) {
            const pages = {
                schedule: 'viewSchedule.php',
                reports: 'reports.php',
                sales: 'sales.php',
                revenue: 'viewRevenue.php',
                feedback: 'viewFeedback.php',
                leave: 'manageLeave.php',
                attendance: 'viewAttendance.php',
                summary: 'summary.php',
                payments: 'supplierPayment.php'
            };
            if (pages[action]) {
