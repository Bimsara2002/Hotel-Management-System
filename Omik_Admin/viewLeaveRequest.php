...
.container { max-width: 1200px; margin: 30px auto; padding: 25px 30px; background: #fff; border-radius: 12px; box-shadow: 0 8px 20px rgba(0,0,0,0.1);}
h1 { text-align: center; margin-bottom: 20px; color: #1f2937; }
.button-back { padding: 10px 18px; background: #007bff; color: #fff; border: none; border-radius: 8px; cursor: pointer; margin-bottom: 15px; }
...
.action-btn { padding: 6px 12px; margin: 2px; border: none; border-radius: 5px; cursor: pointer; font-size: 13px; color: #fff; }
.approve {background: green;} .approve:hover {background: darkgreen;}
.reject {background: red;} .reject:hover {background: darkred;}
</style>
</head>
<body>
<div class="container">
